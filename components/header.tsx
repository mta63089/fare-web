    ...
    <>
      <motion.header
        className={
          ...
          (isScrolled
            ? theme === "dark"
              ? "bg-black/80 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-md"
              : "bg-white/80 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-md"
          ...
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <Link
                  href="#"
                  className="bg-primary inline-flex items-center space-x-2 rounded-sm px-6 py-2.5 font-medium text-white transition-all duration-200 hover:shadow-lg"
                >
                  <span>Order Now</span>
                </Link>
              </motion.div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            key="mobile-menu"
            className="bg-primary fixed inset-0 z-50 flex h-screen w-screen flex-col overflow-y-auto text-white"
